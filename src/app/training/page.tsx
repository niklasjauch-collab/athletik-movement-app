  ...
  if (!session) {
    return (
      <main className="flex-1 max-w-2xl mx-auto px-6 py-16">
        ...
        <Link href="/scans" className="mt-4 inline-block text-sm text-brand-700 underline">
  ...
  return (
    <main className="flex-1 max-w-2xl mx-auto px-6 py-16">
      ...
      <div className="mt-6 flex flex-wrap items-center gap-3">
        ...
        <Link href={`/progress?clientId=${clientId}`} className="text-sm text-slate-500 underline">
